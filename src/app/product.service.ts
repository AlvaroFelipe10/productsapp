...
export class ProductService {
  ...
  private productsSubject$: BehaviorSubject<Product[]> = new BehaviorSubject<Product[]>(null as any);
      ...
      .pipe(
        ...
        map(([products,departments])=> {
          for(let p of products) {
            ...
            p.departments = ids.map((id)=>departments.find(dep=>dep._id==id)) as any;
          }
          return products;
        }),
